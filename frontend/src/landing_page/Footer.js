    ...
    <div className="container p-3">
      <div className="row mb-5 mt-5">
        ...
        <div className="col">
          ...
          <a className=" mb-5 text-muted text-decoration-none" href="">
            About{" "}
          </a>
          <br></br>
          <a className=" mb-5 text-muted text-decoration-none" href="">
        ...
        <div className="col">
          ...
          <a  className="  mb-5 text-muted text-decoration-none"href="">Contact</a>
          <br></br>
          ...
          <br></br>
          <a  className="  mb-5 text-muted text-decoration-none"href="">Downloads and Resources</a>
          <br></br>
        </div>
        <div className="col">
      ...
      <div className="text-muted  mt-5 " style={{fontSize:"14px"}}><p>
